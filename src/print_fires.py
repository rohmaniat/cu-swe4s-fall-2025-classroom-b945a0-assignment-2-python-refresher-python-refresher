...
# rohan$ python3 print_fires.py --file_name Agrofood_co2_emission.csv \
#   --country "United States of America" --country_column 0 --fires_column 3
...
def print_fires(file_name, country_column, country, fires_column, operation):
    ...
    fires = my_utils.get_column(
        file_name, country_column, country, fires_column)
    ...
    print(
        "The nonzero forest fires numbers in {} are {}."
        .format(country, fires))

    # Print the sum total of forest fires in the given country across all years
    print(
        "The sum total of forest fires across all years in {} is {}."
        .format(country, total_fires)
    )
    ...
    if operation == "standard deviation":
        ...
        print(
            "The standard deviation of the forest fire numbers is {}."
            .format(stdev)
        )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Prints forest fire counts each year in a given country and "
    ...
    parser.add_argument(
        "--file_name",
        type=str,
        default="src/agrofood_data_abbreviated.csv",
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Optionally indicate if you would like the mean, median, or "
