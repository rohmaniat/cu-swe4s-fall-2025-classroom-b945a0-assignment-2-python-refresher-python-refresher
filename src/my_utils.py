...
def get_column(file_name, query_column, query_value, result_column):
    ...
    try:
        ...
        return results  # exit if file cannot be opened
    ...
    # Convert string values to floats first
    ...
    # Then convert floats to integers
    for i in range(len(results)):
        try:
...
if __name__ == "__main__":
    print(get_column("src/agrofood_data_abbreviated.csv",
